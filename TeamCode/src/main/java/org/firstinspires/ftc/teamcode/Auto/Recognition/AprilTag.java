...
public class PreloadDetectionPipeline implements VisionProcessor {
    ...
    public int targetAprilTagID = 0;
    public String ALLIANCE = null;

    public String which_case = "CENTER";
...
//                        System.out.println("RIGHTAVG " + rightZoneAverage);
                        ...
                        if (leftZoneAverage > rightZoneAverage) which_case = "LEFT";
                        else which_case = "RIGHT";
    ...
    public void setTargetAprilTagID(Location preloadLocation) {
       ...
       if (ALLIANCE == "RED") targetAprilTagID += 3;
    }
